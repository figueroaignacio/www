...
// Icons
import { AstroIcon, CSSIcon, CVAIcon, ExpressIcon, GitHubIcon, GitIcon, HTMLIcon, JavascriptIcon, JsonIcon, MDXIcon, MarkdownIcon, MaterialIcon, NextJSIcon, NodeJSIcon, PGIcon, PayloadIcon, PnpmIcon, PrismaIcon, RadixIcon, ReactHookFormIcon, ReactIcon, ReactRouterIcon, SanityIcon, TailwindIcon, TurborepoIcon, TypeOrmIcon, TypescriptIcon, VeliteIcon, ViteIcon, ZodIcon } from "@/components/tech-icons";
...
export function TechStack() {
  ...
  return (
    <div className="space-y-8">
      <h2 className="mb-8 font-semibold text-foreground underline decoration-2 underline-offset-4 decoration-primary">Stack</h2>
