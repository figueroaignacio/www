...
export function NavigationBar() {
  ...
  return (
    <nav className="fixed lg:hidden -bottom-4 sm:-bottom-1 sm:rounded-2xl inset-x-0 z-50 mx-auto max-w-2xl w-full backdrop-blur-3xl bg-card/30 border-t border-border px-6 py-4">
