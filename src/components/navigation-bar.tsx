...
export function NavigationBar() {
  ...
  return (
    <nav className="fixed lg:hidden -bottom-5 inset-x-0 z-50 mx-auto max-w-xl w-full rounded-3xl bg-card border border-border shadow-xl px-6 py-4 flex items-center justify-between">
